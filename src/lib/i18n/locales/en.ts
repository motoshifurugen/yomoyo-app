const en = {
  ...
  onboarding: {
    ...
    avatarHeading: 'Pick an avatar',
    avatarContinue: 'Continue',
    notificationHeading: '“I just finished a book” arrives from friends',
    notificationBody: '▼ 2 steps to receive ▼',
    ...
    sendHeading: "Your finished book, \nsomeone's quiet joy",
    sendBody: '▼ 2 steps to send ▼',
