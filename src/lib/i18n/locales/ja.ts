const ja = {
  ...
  onboarding: {
    ...
    avatarHeading: 'あなたらしいアイコンを選んでください',
    avatarContinue: 'すすむ',
    notificationHeading: '誰かの「読み終えたよ」が、静かに届きます',
    notificationBody: '友だちが本を読み終えたときだけ、そっとお知らせします。',
    receiveHighlightNotify: 'お知らせを受け取る準備をする',
    receiveHighlightConnect: '気になる友だちとつながる',
    allowButton: 'お知らせを受け取る',
    skipLink: 'あとで設定する',
    sendHeading: 'あなたの「読了」も、誰かの楽しみに',
    sendHighlightShareId: 'あなたのIDを友だちに教える',
    sendHighlightRecord: '読み終えた本を記録する',
    sendButton: 'ここから、はじめる',
